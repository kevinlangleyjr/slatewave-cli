...
func TestInstallOne_PersistsRecordOnSuccess(t *testing.T) {
	...
	if err := installOne(t.Context(), "okayish", false, installFlags{}, env.out); err != nil {
...
func TestInstallOne_SuppressFinalSkipsDoneLine(t *testing.T) {
	...
	if err := installOne(t.Context(), "okayish", true, installFlags{}, env.out); err != nil {
...
func TestInstallOne_DryRunSkipsState(t *testing.T) {
	...
	if err := installOne(t.Context(), "okayish", false, installFlags{DryRun: true}, env.out); err != nil {
...
func TestInstallOne_UnknownSlugReturnsNoManifestError(t *testing.T) {
	...
	err := installOne(t.Context(), "ghost", false, installFlags{}, env.out)
	if err == nil {
...
func TestInstallOne_BlocksUnsupportedOS(t *testing.T) {
	...
	err := installOne(t.Context(), "okayish", false, installFlags{}, env.out)
	if err == nil {
...
func TestInstallBulk_SkipsAlreadyInstalledAndCounts(t *testing.T) {
	...
	if err := installBulk(t.Context(), []string{"okayish", "second"}, installFlags{}, env.out); err != nil {
...
func TestInstallBulk_AllAlreadyInstalledReportsNothingToInstall(t *testing.T) {
	...
	if err := installBulk(t.Context(), []string{"okayish"}, installFlags{}, env.out); err != nil {
		t.Fatalf("installBulk: %v", err)
	}
...
func TestUninstallOne_RemovesRecord(t *testing.T) {
	...
	if err := uninstallOne("okayish", uninstallFlags{}, env.out); err != nil {
...
func TestUninstallOne_DryRunKeepsRecord(t *testing.T) {
	...
	if err := uninstallOne("okayish", uninstallFlags{DryRun: true}, env.out); err != nil {
...
func TestUninstallOne_NotInstalledErrors(t *testing.T) {
	env := setupCmdEnv(t)
	err := uninstallOne("ghost", uninstallFlags{}, env.out)
...
func TestUninstallBulk_NothingInstalled(t *testing.T) {
	...
	if err := uninstallBulk(uninstallFlags{}, env.out); err != nil {
...
func TestUninstallBulk_CategoryFilterMissesAllInstalled(t *testing.T) {
	...
	err := uninstallBulk(uninstallFlags{Category: "terminal"}, env.out)
...
func TestUpdateOne_ManualReturnsNoAutomatedUpdate(t *testing.T) {
	...
	err := updateOne(t.Context(), "okayish", false, updateFlags{}, env.out)
	if err == nil {
...
func TestUpdateOne_UnknownSlugErrors(t *testing.T) {
	...
	err := updateOne(t.Context(), "ghost", false, updateFlags{}, env.out)
	if err == nil || !strings.Contains(err.Error(), "no manifest") {
...
func TestUpdateBulk_ManualThemeIsSkippedNotFailed(t *testing.T) {
	...
	if err := updateBulk(t.Context(), updateFlags{}, env.out); err != nil {
...
func TestUpdateBulk_CategoryFilterMatchesNothing(t *testing.T) {
	...
	// okayish is editor; ask for terminal — should report none.
	err := updateBulk(t.Context(), updateFlags{Category: "terminal"}, env.out)
	if err == nil || !strings.Contains(err.Error(), `no installed themes in category "terminal"`) {
		t.Errorf("category filter with no matches: err = %v, want `no installed themes in category`", err)
	}
}
...
func TestStatusAll_EmptyStatePrintsHint(t *testing.T) {
	...
	s, _ := state.Load()
	if err := statusAll(s, env.out); err != nil {
